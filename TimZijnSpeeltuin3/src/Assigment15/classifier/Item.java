...
/**
 * Represents an item that can be classified. (Note that Category is not
 * implemented as figure 4.3 of the book suggests.)
 */
public class Item {
	 ...
	 * @param features
	 *            An array of the features this item has
	 */
	 ...
	 * 
	 * @param featureName
	 *            A String which matches a featurename.
