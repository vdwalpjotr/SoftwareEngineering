...
public class DecisionTree implements Classifier {
	...
	private static Node buildDecisionTree(Map<Item, String> trainingsSet, Map<String, FeatureType> features) {
		...
		Map<String, HashMap<Item, String>> partitions = performSplit(trainingsSet, splitFeature,
	 ...
	 */
	private static Map<String, HashMap<Item, String>> performSplit(Map<Item, String> trainingsSet, String split,
